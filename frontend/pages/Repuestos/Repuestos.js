import { getAllRepuestos } from "../js/API.js";
...
async function showRepuestos() {
    const data = await getAllRepuestos();
    const bodyCard = document.getElementById('container');
    data.forEach((repuestos) => {
        const { nombre, precio, cantidad, img } = repuestos;
        bodyCard.innerHTML += `
        <div class="col-md-4">
            ...
            <div class="card rounded-0">
                ...
                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                    <ul class="list-unstyled">
                        <li><a class="btn btn-success text-white" href="../Detalles-Rep/shop-rep.html"></i>Detallado</a></li>
                    </ul>
                </div>
            </div>
            <div class="card-body">
                ...
                <p class="text-center mb-0">Precio:${precio} </p>
            </div>
        </div>
    </div>
        `
